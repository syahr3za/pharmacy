		...
		<div class="col-8">
			<div class="card">
				<div class="card-header">
	   	 			<a href="#" @click="addData()" class="btn btn-sm btn-primary pull-right"><i class="fa fa-plus-circle">Create New Permission</i></a>
				</div>
		  			<div class="card-body">
			...
			<form method="POST" :action="actionUrl" autocomplete="off" @submit="submitForm($event, data.id)">
		        ...
		        @csrf	
			        ...
			        <div class="form-group">
		        		<label>Name</label>
		        		<input type="text" name="name" class="form-control" placeholder="Enter Permission Name" :value="data.name">
			        </div>
	      		</div>
...
<script type="text/javascript">
	var	actionUrl = '{{ url('permissions') }}';
	var apiUrl = '{{ url('api/permissions') }}';
